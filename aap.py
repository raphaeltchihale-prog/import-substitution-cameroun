...
if selected == "Accueil":
    if not st.session_state.logged_in:
        ...
        # ------------------- ONGLETS ------------------- #
        tabs = st.tabs([
            "📊 Descriptif","📈 Analyse globale du Taux d'import-substitution","🏆 Performance","📊 Tableau de Bord",
       ...
       # ====== Onglet Taux d'import-substitution ====== #
        ...
        # Évolution taux d'import-substitution
                fig2 = px.bar(
                    df_f,
                    x=col_annee,
                    y=metric,
...
# ====== Onglet Tableau de Bord ====== #
    ...
    # Projection sur 7 ans
                ...
                fig1.update_layout(
                    title="📈 Production locale et projection", 
                    xaxis_title="Année", 
